...
if not EMAIL_ADDRESS or not EMAIL_PASSWORD:
    print("⚠️ WARNING: Email credentials are missing. Payslips will not be emailed.")
...
# Read employee data
try:
    df = pd.read_excel(file_path, dtype={"Employee ID": str}, engine="openpyxl")
...
# Convert numeric values and fill missing ones
